...
export const features = [
  {
    ...
    title: "Earn More",
    description:
      "Sell your products to millions of customers and grow your business with Bazario.",
  },
  {
    id: 2,
    ...
    description:
      "Get paid securely and on time with our trusted payment gateway.",
  },
  {
    id: 3,
    ...
    description:
      "We handle shipping and delivery, so you can focus on growing your business.",
  },
  {
    id: 4,
    ...
    description:
      "Access a large customer base and increase your sales with our platform.",
  },
  {
    id: 5,
    ...
    description:
      "Track your sales and performance with detailed analytics and reports.",
  },
  {
    id: 6,
    ...
    description:
      "Become a seller in just a few simple steps and start selling immediately.",
  },
];
...
export const productCategories = [
  ...
  },
  {
    id: 3,
    name: "Jewellery",
    subCategories: ["Earrings", "Necklaces", "Rings", "Bracelets", "Anklets"],
    image: () => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
