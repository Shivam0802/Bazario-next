    ...
    <>
      ...
      <section className="flex flex-col items-center justify-between m-6 bg-gradient-to-b from-[#fdfbfb] to-[#ebedee] rounded-[2.5rem] p-3 md:p-10 lg:p-10 pb-20">
        <div className="flex flex-col items-center justify-center">
          <h1 className="text-[2rem] md:text-[4rem] lg:text-[4rem] font-bold uppercase letter-spacing-2">
            Contact Us
          </h1>
          <p className="text-[1rem] md:text-lg lg:text-lg font-medium text-gray-900 md:text-center lg:text-center text-justify mt-4 md:mt-10 lg:mt-10 mb-16 md:mx-80 lg:mx-80 leading-5">
            Get in touch with us for any queries, feedback, or support. We are
            here to assist you and ensure you have the best experience possible.
            Feel free to reach out to us through the contact form below, or via
            the provided phone number and email address. We look forward to
            hearing from you!
          </p>
        </div>
          ...
          <div className="max-w-[90rem]">
            <div className="flex lg:flex-row flex-col lg:gap-0 gap-10 shadow-slate-900 shadow-2xl rounded-[2rem]">
              <div className="bg-gray-50 p-5 lg:p-11 w-full">
                ...
                <div className="flex items-center justify-start mt-10">
                  ...
                  <p className="text-[1.15rem] font-semibold text-[#3C3D37] ml-2">
                    Bangalore Palace, Bangalore - 560052
                  </p>
                </div>
                ...
                <div className="flex items-center justify-start mt-5">
                  ...
                  <p className="text-[1.15rem] font-semibold text-[#3C3D37] ml-2">
                    <a
                      href="mailto: abc@yopmail.com"
                      className="text-[#3C3D37]"
                    >
                      abc@yopmail.com
                    </a>
                  </p>
                ...
                <div className="flex items-center justify-start mt-5">
                  <ul className="flex justify-center items-center mt-5 gap-4">
                    ...
                    <li>
                      <a
                        className="text-gray-500 hover:text-[#6A80B9]"
                        href=""
              ...
              <div className="bg-gray-50 px-3 py-5 lg:p-11 w-full">
                ...
                <form
                  className="px-1 grid items-center"
                ...
                >
                  <div className="grid gap-1" id="form">
                    ...
                    <button
                      type="submit"
                      className="relative px-10 py-3.5 overflow-hidden group bg-gradient-to-r from-gray-700 to-black relative hover:bg-gradient-to-r hover:from-gray-600 hover:to-black text-white transition-all ease-out duration-300"
                    >
                      <span className="absolute right-0 w-10 h-full top-0 transition-all duration-1000 transform translate-x-12 bg-white opacity-10 -skew-x-12 group-hover:-translate-x-36 ease"></span>
                      <span className="relative text-[1.25rem] font-medium uppercase tracking-widest">
                        Submit
                      </span>
                    </button>
                  </div>
      ...
      <section className="flex flex-col md:flex-row lg:flex-row items-center justify-between m-6 bg-gradient-to-r from-[#f4f4f4] via-[#f4f4f4] to-[#ebedee] rounded-[2.5rem] p-3 md:p-10 lg:p-10 pb-20">
        <img
          src="/faq.webp"
          alt="FAQ"
          className="md:w-[40%] lg:w-[40%] h-auto"
        />
        <div className="flex flex-col items-center justify-around w-full">
          <h1 className="text-[1.7rem] md:text-[4rem] lg:text-[4rem] font-bold ">
          ...
          <div className="flex flex-col items-center justify-center md:w-[90%] lg:w-[90%] md:pl-20 lg:pl-20">
            {FAQ.slice(0, 5).map((item) => (
              <div
                key={item.id}
                className="flex flex-col items-start justify-center w-full bg-white shadow-slate-900 shadow-2xl mb-5"
              >
                <div className="flex items-center justify-between w-full py-3 px-5">
                  <h1 className="md:text-[1.25rem] lg:text-[1.25rem] font-semibold text-[#3C3D37] pl-2">
                    {item.question}
                  </h1>
                  {accordian === item.id ? (
                    <Minus
                ...
                <div
                  className={`bg-gradient-to-t from-[#fdfbfb] to-[#ebedee] transition-all duration-300 ease-in-out overflow-hidden ${
                    accordian === item.id
                      ? "max-h-[200px] opacity-100"
                      : "max-h-0 opacity-0"
                  }`}
                >
                  <p className="text-[0.9rem] md:text-[1rem] lg:text-[1.10rem] text-justify font-medium text-[#3C3D37] pl-2 pb-2 mx-6 mt-2 md:m-4 lg:m-4 leading-4 md:leading-6 lg:leading-6">
                    {item.answer}
                  </p>
                </div>
              </div>
      ...
      <button
        ...
        className="bg-[#3C3D37] rounded-full w-12 h-12 flex justify-center items-center fixed bottom-10 right-10 cursor-pointer hover:shadow-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"
