           ...
           {id && (<Link href={`/products/${id}`} className="bg-[#fff0dfd9] flex flex-col gap-1 rounded-2xl cursor-pointer hover:shadow-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300">
                ...
                <div className="flex flex-col justify-between h-[11rem] md:h-[8rem] lg:h-[10rem] px-3 pt-1 pb-2">
                    ...
                    <div className="flex flex-row justify-between items-center gap-4">
                        <span className="font-extrabold text-green-900 text-lg md:text-md lg:text-[1.2rem]"> ₹{product.discountedPrice} </span>
                        <div className="group relative flex justify-center items-center text-zinc-900 text-sm font-bold">
                            <div onClick={handleAddToCart} className="shadow-md flex items-center group-hover:gap-2 bg-[#FFDAB3] p-3 rounded-full cursor-pointer duration-300">
